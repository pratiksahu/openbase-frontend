...
test.describe('Goal Management Operations', () => {
  ...
  test('should open goal detail page', async () => {
    // Click on first goal
  ...
  test('should change goal status', async () => {
    // Navigate to goal detail
    await navigateToGoalDetail();
  ...
  test('should archive goal', async () => {
    // Navigate to goal detail
    await navigateToGoalDetail();
  ...
  test('should delete goal with confirmation', async () => {
    // Navigate to goal detail
    await navigateToGoalDetail();
  ...
  test('should duplicate goal', async () => {
    // Navigate to goal detail
    await navigateToGoalDetail();
  ...
  test('should search goals', async () => {
    // Find search input
  ...
  test('should display goal statistics', async () => {
...
test.describe('Goal List Views', () => {
  ...
  test('should paginate large numbers of goals', async () => {
