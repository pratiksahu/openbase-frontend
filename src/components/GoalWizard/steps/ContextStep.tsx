...
const TEMPLATE_CARDS = [
  {
    ...
    title: 'Business Goal',
    description:
      'Revenue targets, market expansion, or operational improvements',
    icon: TrendingUp,
    color:
  ...
  },
  {
    ...
    icon: GraduationCap,
    color:
      'bg-purple-50 border-purple-200 hover:bg-purple-100 dark:bg-purple-950/30 dark:border-purple-800',
  ...
  },
  {
    ...
    icon: Users2,
    color:
      'bg-orange-50 border-orange-200 hover:bg-orange-100 dark:bg-orange-950/30 dark:border-orange-800',
    iconColor: 'text-orange-600 dark:text-orange-400',
    examples: [
      'Improve team productivity by 30%',
      'Reduce sprint overruns',
...
export const ContextStep: React.FC<ContextStepProps> = ({
  ...
  const CategoryIcon =
    CATEGORY_ICONS[data.category || GoalCategory.PERSONAL] || HelpCircle;
      ...
      <div className={cn('space-y-8', className)}>
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Start by providing background information and selecting a template
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-sm">
              Select a template to get started faster with pre-filled
              suggestions.
            </p>
          </div>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <Label
              htmlFor="initialGoalDescription"
              className="text-base font-semibold"
            >
              Initial Goal Description
            </Label>
            <p className="text-muted-foreground text-sm">
              Provide a rough description of what you want to achieve.
              We&apos;ll refine this in later steps.
            </p>
          </div>
          ...
          <Textarea
            ...
            onChange={e =>
              handleChange('initialGoalDescription', e.target.value)
            }
        ...
        <div className="space-y-4">
          ...
          {errors.category && (
            <div className="text-destructive text-sm">{errors.category[0]}</div>
          )}
        </div>
        ...
        <div className="space-y-4">
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="max-w-xs">
                    Identify people or groups who will be affected by or
          ...
          <StakeholderInput
            ...
            onChange={stakeholders =>
              handleChange('stakeholdersInvolved', stakeholders)
            }
            disabled={readOnly}
          />
        </div>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-sm">
              Any additional context, history, or relevant information that
              might be helpful.
            </p>
          </div>
